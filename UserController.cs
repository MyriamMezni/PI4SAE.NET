...
namespace PI4SAE.Controllers
{
    public class UserController : Controller
    {
       // string Baseurl = "http://localhost:8082/";
        ...
        public ActionResult DetailsKid(int idKid)
        {
            HttpClient client = new HttpClient();
            Kid Kid = null;
            client.BaseAddress = new Uri("http://localhost:8082");
            //HTTP GET("SpringMVC/servlet/GetActivities")
            var responseTask = client.GetAsync("SpringMVC/servlet/retrieveKid/" + idKid.ToString());
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> CreateKinderGartenAdmin(KinderGartenAdmin epm)
        {
            string Baseurl = "http://localhost:8082/";
        ...
        // GET: User/Details/5
         public ActionResult authenticateUser2(int id)
         {
             HttpClient client = new HttpClient();
             User User = null;
             client.BaseAddress = new Uri("http://localhost:8082");
